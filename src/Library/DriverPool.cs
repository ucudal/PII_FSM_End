...
namespace RideShareUCU
{
    public class DriverPool : Driver
    {
        ...
        public DriverPool(string name, string lastName, string id, string profilePicPath, string vehiculo, string bio, int maxPassangers) : base(name, lastName, id, profilePicPath, vehiculo, bio)
        {
